  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 p-4">
      <div className="bg-white/20 backdrop-blur-md shadow-2xl rounded-2xl p-8 w-full max-w-md">
        <h2 className="text-3xl text-white font-bold mb-6 text-center drop-shadow-lg">Sign Up</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <select
            ...
            className="w-full p-3 rounded-lg bg-white/10 text-white border border-white/20 focus:outline-none focus:ring-2 focus:ring-white/50"
          >
